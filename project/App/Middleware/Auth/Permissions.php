...
class Permissions
{
  ...
  public static $permissions = [
    ...
    'manager' => 'getPointsDeVente|getPointsDeVenteById|sortPointsDeVente|createPointDeVente|updatePointDeVente|deletePointDeVente|index|comparaisonVilles|analyseDemographique|analyseConcurrence|calculRentabilite|logout|createCategory',
